...
You can also refer to [build.py](https://gitcode.com/Cangjie/cangjie_runtime/blob/main/std/build.py) or use the `--help` option to learn more about compilation options:
